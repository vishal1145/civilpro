...
if(isset($_POST['changstatus'])){
  ...
  if($res_data_update >0){
    ...
    $insert_noti_update = "insert into notification(empl_id,text,type, project_id) 
    select dl.emp_id , 'Report has been dispatch for date ','Dispatch_Report', -99 from dispatch_log dl where id= $dispatch_id";
