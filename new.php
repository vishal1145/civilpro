	...
	/*	var availableTags = [
		...
		jQuery(function() {
		   jQuery("#myAutocompleteMultiple").autocomplete({
		        source: "teamleader.php",
		        multiselect: true,
		        select: function( event, ui ) {		        	
		            event.preventDefault();
		           jQuery("#myAutocompleteMultiple").val(ui.item.id);
		         /*  jQuery("#myAutocompleteMultiple").val(ui.item.value);*/
		        }
		    });
		});

		jQuery(function() {
		   jQuery("#myAutocompleteMultipleTeam").autocomplete({
		        source: "teammember.php",
		        multiselect: true,
		        select: function( event, ui ) {
		            event.preventDefault();
		           jQuery("#myAutocompleteMultipleTeam").val(ui.item.id);
		        }
		    });
		});

		jQuery(function() {
		   jQuery("#add_machinea").autocomplete({
		        source: "automachine.php",
		        multiselect: true,
		        select: function( event, ui ) {
		            event.preventDefault();
		           jQuery("#add_machinea").val(ui.item.id);
		        }
		    });
		});

		jQuery(function() {
		   jQuery("#aotumaterial").autocomplete({
		        source: "automaterial.php",
		        multiselect: true,
		        select: function( event, ui ) {
		            event.preventDefault();
		           jQuery("#aotumaterial").val(ui.item.id);
		        }
		    });
		});
...
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		jQuery("#butsasaton").click(function(){
	//alert(jQuery('.ui-autocomplete-multiselect ui-state-default ui-widget ui-state-active').children(".ui-autocomplete-multiselect-item").text());
			//alert(jQuery(".main-div").children().text());
		});
	});
							...
							<div class="col-md-6">
								...
								<input id="myAutocompleteMultiple" type="text"  name="project_leader" class="form-control" value="" autocomplete="off"  />
								</div>
								</div>
							</div>
							<div class="col-md-6">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input id="myAutocompleteMultipleTeam" type="text"  name="team_name" class="form-control" />
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<!-- <input class="form-control typeahead" type="text" name="machine" id="add_machine" > -->
											<input id="add_machinea"  class="form-control typeahead" type="text" name="machine" >
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input id="aotumaterial" type="text"  name="team_name" class="form-control" />
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
