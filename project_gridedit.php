...
/* ========================================================================================= */
	...
	$insert_noti_update_1 = "update notification set project_id = ".$products_id." where project_id  = -1";
	$res_noti_1 = mysqli_query($con,$insert_noti_update);

	if($res_data){ //echo "Records updated successfully"; 
	 echo "<script>location.href='http://$_SERVER[HTTP_HOST]/civilpro/projects.php';</script>";
