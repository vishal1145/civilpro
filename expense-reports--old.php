...
if(isset($_POST['Add_Timecard'])){
   ...
   $log_user_quryy = "INSERT INTO time_card (project_name, employee_id, deadline, total_hours, remain_hours, work_type, card_date, hours, description, machine, machine_hours,time_set) VALUES ('$project_name','$employee_id' , '$deadline', '$total_hour','$remain_hour', '$work_type', '$work_date','$work_hours', '$description', '$machine_name', '$hourss',$time_set)";
...
<!-- ============================ searching ================================= -->
				<?php
					...
					$Time_Card = "SELECT * FROM field_report";
...
<!-- ===================================================================== -->
		...
		<?php
				...
				$time_set = "SELECT * FROM `time_card` ORDER BY `time_card`.`time_set` DESC";
