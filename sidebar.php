...
$connn = mysqli_connect('localhost','root','','attodayi_civilpro');
           ...
           <div class="sidebar" id="sidebar">
                ...
                ?>
                        <ul class="list-unstyled " id="projectid" class="form-control"style="display: none;" name="project_id">
							...
							<li <?php echo ($current_url == "dispatch_report.php") ? 'class="Projects '.$activeClass.'"' : 'class="Projects '.$removeClass.'"' ?>> 
								<a href="dispatch_report.php">Daily Dispatch Report</a>
							</li>
							<!--<li class="Tasks"> 
