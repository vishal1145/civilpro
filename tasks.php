...
<div class="sidebar" id="sidebar"  >
                <div class="sidebar-inner slimscroll">
                    ...
                    <?php
                $log_user_qury = "select IFNULL(pt.counts,0) as counts, p.Project_id, p.Project_name from Project p 
                left join (select count(1) as counts, Project_id from project_tasks group by Project_id ) pt 
